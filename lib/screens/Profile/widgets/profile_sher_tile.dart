...
class ProfileSherTile extends StatefulWidget {
  ...
  @override
  State<ProfileSherTile> createState() => _ProfileSherTileState();
}

class _ProfileSherTileState extends State<ProfileSherTile> {
